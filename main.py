...
def login():
    ...
    w = webdriver.Chrome(executable_path="C:\\chromedriver.exe", chrome_options=chrome_options)
    time.sleep(5)
    w.get(
    ...
    w.find_element(By.XPATH, '//*[@id="__next"]/div[1]/div[2]/div/header/div[2]/button[2]/div').click()
    w.find_element(By.XPATH, '//*[@id="radix-:R1jlj6:"]/div[3]/div/button[1]').click()
    time.sleep(1)
